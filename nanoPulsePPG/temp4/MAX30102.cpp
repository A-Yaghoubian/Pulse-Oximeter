...
void MAX30102::enableDIETEMPRDY(void) {
  bitMask(0x03, (byte)~0b00000010, 0x02);
}
...
float MAX30102::readTemperature() {
  ...
  {
    uint8_t response = readRegister8(0x21);
  ...
  int8_t tempInt = readRegister8(0x1F);
  uint8_t tempFrac = readRegister8(0x20);
